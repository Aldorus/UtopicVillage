...
use Exod\Bundle\UtopicVillageBundle\Entity\Role;
use Exod\Bundle\UtopicVillageBundle\Form\RoleType;
...
class RoleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ExodUtopicVillageBundle:Role')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ExodUtopicVillageBundle:Role')->find($id);
     ...
     * @Method("post")
     * @Template("ExodUtopicVillageBundle:Role:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("ExodUtopicVillageBundle:Role:edit.html.twig")
     */
