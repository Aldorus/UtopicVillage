...
class ExodBundleUtopicVillageBundleEntityUserProxy extends \Exod\Bundle\UtopicVillageBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'login', 'password', 'salt', 'name', 'firstname', 'birthdate', 'email', 'lastConnection', 'picture', 'report', 'active', 'role', 'sanction', 'dateSanction', 'latitude', 'longitude', 'amount', 'commentaire');
    }
